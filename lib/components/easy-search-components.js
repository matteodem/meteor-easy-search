(function () {
    ...
    SearchVars.set('global', { 'notSearching' : true });

    // TODO: Remove generateId and only use index from now on!
    // TODO: Make the search extendable with an API
    // TODO: Migrate to official elastic-search library
    // TODO: respect caseSensitive in mongo-db and elastic-search
    // TODO: Change to initEasySearch(fields, options)
    // TODO: Tests
        ...
        'keyup input' : function (e) {
            ...
            if (searchValue.length === 0) {
                _.each(this.index, function (index) {
                    SearchVars.set(generateId(index, eventScope.id), { 'searchingDone' : false });
                });
            ...
            SearchVars.set('global', { 'notSearching' : false });
    ...
    Template.esEach.helpers({
        'elasticSearchDoc' : function () {
            ...
            if (SearchVars.get('global', 'notSearching')) {
                return [];
            }
