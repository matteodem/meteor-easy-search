  ...
  Template.esInput.created = function () {
    this.autorun(function () {
      ...
      EasySearch.eachIndex(data.index, function (index, opts) {
        ...
        opts.subscriptionHandle = Meteor.subscribe(index + '/easySearchCount');
      });
    });
  };

  Template.esInput.destroyed = function () {
    EasySearch.eachIndex(Template.currentData().index, function (index, opts) {
      opts.subscriptionHandle.stop();
    });
  };
