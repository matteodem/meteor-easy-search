...
Easy Search is a simple and flexible solution for adding Search Compoenents to your Meteor App. Use the Blaze Components + Javascript API to get started. Since of v1.0 it uses mongo-db for searching by default, but if you want to go fast you can also use [Elastic Search](#using-elastic-search).
